...
int main()
{
    ...
    if (sum > 5000)
    {
        ...
        {
            printf("you are eligible for 50%% discount \n  ");
            int d = 50;
            al(d, sum);
        }
        ...
        {
            printf("you are eligiible for 40%% discount \n");
            int d = 40;
            al(d, sum);
        }
    }
    ...
    else if (sum > 4000)
    {
        if (a > 2000 || b > 2000 || c > 2000)
        {
            ...
            printf("you are elligible for 40 %% discount \n");
            int d = 40;
            al(d, sum);
        }
        else
        {
            printf("you are eligible for 35 %% discont \n ");
            int d = 35;
            al(d, sum);
        }
    }
